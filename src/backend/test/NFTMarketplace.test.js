...
describe('NFTMarketplace', function () {
  let nft, deployer, addr1, addr2, marketplace;
  // let marketplace;
  // let deployer;
  // let addr1;
  // let addr2;
  ...
  describe('Deployment', function () {
    ...
    it('Should track name and symbol of the nft collection', async function () {
      // const nftName = 'Hell NFT';
      // const nftSymbol = 'HELL';
      expect(await nft.name()).to.equal('Hell NFT');
      expect(await nft.symbol()).to.equal('HELL');
    });
